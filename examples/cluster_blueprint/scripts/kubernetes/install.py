...
if __name__ == '__main__':
    ...
    if 'centos' in linux_distro:
        ...
        kubernetes_install = execute_command(
            'sudo yum -y install kubeadm-1.9.3-0 '
            'kubelet-1.9.3-0 kubectl-1.9.3-0'
        )
        ...
        execute_command('sudo apt-get install -y kubelet=1.9.3-00 '
                        'kubeadm=1.9.3-00 kubectl=1.9.3-00')
    else:
